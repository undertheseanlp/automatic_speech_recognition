...
if __name__ == '__main__':
    s = calculate_wer("khach san".split(), "khach san cua toi".split())
    assertions.assertAlmostEqual(s, 1)
    s = calculate_wer("khach san cua".split(), "khach san cua toi".split())
    assertions.assertAlmostEqual(s, 0.333, 3)
